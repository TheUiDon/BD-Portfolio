                      ...
                      <div className="card-text desc-hide d-none pb-5  aos-init aos-animate" data-aos="fade-right">
                        <div className="row aos-init aos-animate" data-aos="fade-right">
                          ...
                          <div className="col-2  aos-init aos-animate" data-aos="fade-right">
                            ...
                            {true && <i className="fa-brands fa-html5  aos-init aos-animate" data-aos="fade-right"></i>}
                            {true  && <i className="fa-brands fa-css3  aos-init aos-animate" data-aos="fade-right"></i>}
                            {true && <i className="fa-brands fa-js  aos-init aos-animate" data-aos="fade-right"></i>}
                            {`${props.rt}` == '1'  && <i className="fa-brands fa-react  aos-init aos-animate" data-aos="fade-right"></i>}
                            {`${props.php}` == '1'  && <i className="fa-brands fa-php  aos-init aos-animate" data-aos="fade-right"></i>}
                            {`${props.wp}` == '1' && <i className="fa-brands fa-wordpress  aos-init aos-animate" data-aos="fade-right"></i>}
                            {true && <i className="fa-brands fa-github  aos-init aos-animate" data-aos="fade-right"></i>}
                          </div>
                        </div>
                      </div>
                    </div>
